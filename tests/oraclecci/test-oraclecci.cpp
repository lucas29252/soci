...
backend_factory const &backEnd = *soci::factory_oraclecci();

// Extra tests for date/time
TEST_CASE("OracleCCI datetime", "[oraclecci][datetime]")
{
...
// explicit calls test
TEST_CASE("OracleCCI explicit calls", "[oraclecci]")
{
    soci::session sql(backEnd, connectString);
...
TEST_CASE("OracleCCI blob", "[oraclecci][blob]")
{
    {
        soci::session sql(backEnd, connectString);
...

        {
            ...
            oraclecci_session_backend *sessionBackEnd
                = static_cast<oraclecci_session_backend *>(sql.get_backend());

            oraclecci_blob_backend *blobBackEnd
                = static_cast<oraclecci_blob_backend *>(b.get_backend());
...
TEST_CASE("OracleCCI nested statement", "[oraclecci][blob]")
{
    soci::session sql(backEnd, connectString);
...
// ROWID test
TEST_CASE("OracleCCI rowid", "[oraclecci][rowid]")
{
    soci::session sql(backEnd, connectString);
    basic_table_creator tableCreator(sql);
...
TEST_CASE("OracleCCI stored procedure", "[oraclecci][stored-procedure]")
{
    soci::session sql(backEnd, connectString);
...
TEST_CASE("OracleCCI user-defined objects", "[oraclecci][type_conversion]")
{
    soci::session sql(backEnd, connectString);
    {
        basic_table_creator tableCreator(sql);
...
TEST_CASE("OracleCCI user-defined objects in/out", "[oraclecci][type_conversion]")
{
    soci::session sql(backEnd, connectString);
...
TEST_CASE("OracleCCI null user-defined objects in/out", "[oraclecci][null][type_conversion]")
{
    soci::session sql(backEnd, connectString);
...
TEST_CASE("OracleCCI bulk insert", "[oraclecci][insert][bulk]")
{
    soci::session sql(backEnd, connectString);
...
TEST_CASE("OracleCCI bulk fetch", "[oraclecci][fetch][bulk]")
{
    soci::session sql(backEnd, connectString);
...
TEST_CASE("OracleCCI ORM", "[oraclecci][orm]")
{
    soci::session sql(backEnd, connectString);
...
TEST_CASE("OracleCCI ORM by index", "[oraclecci][orm]")
{
    soci::session sql(backEnd, connectString);
...
TEST_CASE("OracleCCI large strings as long", "[oraclecci][compatibility]")
{
    soci::session sql(backEnd, connectString);
...
TEST_CASE("OracleCCI const and modifiable parameters", "[oraclecci][use]")
{
    soci::session sql(backEnd, connectString);
...
TEST_CASE("OracleCCI to_number with rowset", "[oraclecci][rowset][to_number]")
{
    soci::session sql(backEnd, connectString);
...
// long long test
TEST_CASE("OracleCCI long long", "[oraclecci][longlong]")
{
    {
        soci::session sql(backEnd, connectString);
...
TEST_CASE("OracleCCI DDL with metadata", "[oraclecci][ddl]")
{
    soci::session sql(backEnd, connectString);
...
TEST_CASE("Bulk iterators", "[oraclecci][bulkiters]")
{
    soci::session sql(backEnd, connectString);
...
int main(int argc, char** argv)
{
    ...
    {
        std::cerr << "ORACLE_HOME environment variable must be defined for OracleCCI tests.\n";
        std::exit(1);
    }
